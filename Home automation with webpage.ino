...
void loop()
{
 ...
 // client.println("*{background-image: url("https://www.mckennaconsultants.com/wp-content/uploads/2020/02/big-data-iot-and-the-cloud.jpg");}");
  ...
  client.println("<strong>AIR_CONDITIONER </strong>");
  client.println("<br>");
  client.println("<button> SWITCH ON</button>");
  client.println("<button> SWITCH ON</button>");
  client.println("<button> SWITCH ON</button>");
  client.println("<br>");
  client.println("<button> SWITCH OFF</button>");
  client.println("<button> SWITCH OFF</button>");
  client.println("<button> SWITCH OFF</button>");
  ...
  client.println("<strong>AIR_CONDITIONER</strong>");
  client.println("<br>");
  client.println("<td> <button> SWITCH ON</button> </td>");
  client.println("<td> <button> SWITCH ON</button></td>");
  client.println("<td> <button> SWITCH ON</button></td>");
  client.println("<br>");
  client.println("<td> <button> SWITCH OFF</button> </td>");
  client.println("<td> <button> SWITCH OFF</button></td>");
  client.println("<td> <button> SWITCH OFF</button></td>");
